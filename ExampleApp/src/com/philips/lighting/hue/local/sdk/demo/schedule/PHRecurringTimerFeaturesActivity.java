...
/**
 * Lists all Recurring Timer features found in SDK
 * 
 * @author Pallavi P. Ganorkar.
 */
public class PHRecurringTimerFeaturesActivity extends Activity implements
        OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scheduleFeatureListView.setAdapter(new ArrayAdapter<String>(this,
                android.R.layout.simple_list_item_1, getResources()
                        .getStringArray(R.array.recurring_timer_features)));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        case 0:
            ...
            intent = new Intent(this, PHCreateRecurringTimerActivity.class);
            break;
        case 1:
            if (recurringTimers.size() == 0) {
                PHWizardAlertDialog.showErrorDialog(this,
                        R.string.txt_no_timers);
                return;
            }
            intent = new Intent(this, PHUpdateRecurringTimerActivity.class);
            break;
        case 2:
            if (recurringTimers.size() == 0) {
                PHWizardAlertDialog.showErrorDialog(this,
            ...
            intent = new Intent(this, PHRemoveRecurringTimerActivity.class);
            break;
