...
/**
 * Lists all Non Recurring Schedule features found in SDK
 * 
 * @author Pallavi P. Ganorkar.
 */
public class PHNonRecurringScheduleFeaturesActivity extends Activity implements
        OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scheduleFeatureListView.setAdapter(new ArrayAdapter<String>(this,
                ...
                getResources().getStringArray(
                        R.array.non_recurring_schedule_features)));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        case 0:
            ...
            intent = new Intent(this,
                    PHCreateNonRecurringScheduleActivity.class);
            break;
        case 1:
            if (nonRecurringSchedule.size() == 0) {
                PHWizardAlertDialog.showErrorDialog(this,
                        R.string.txt_no_timers);
                return;
            }
            intent = new Intent(this,
                    PHUpdateNonRecurringScheduleActivity.class);
            break;
        case 2:
            if (nonRecurringSchedule.size() == 0) {
                PHWizardAlertDialog.showErrorDialog(this,
            ...
            intent = new Intent(this,
                    PHRemoveNonRecurringScheduleActivity.class);
            break;
